                ...
                <div class="col-12">
                    <div class="card border-0 rounded-1 shadow-sm">
                        <div class="card-body mb-4">
                            <form action="/admin/content/{{$content->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    ...
                                    <input  type="file" name="photo" class="form-control fs-sm text-gray rounded-1" id="">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="mt-3">
                                        ...
                                        <input  type="text" name="title" class="form-control fs-sm text-gray form-control-lg rounded-1" value="{{$content->title}}" id="">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="mt-3">
                                        ...
                                        <input  type="text" name="sub_title" class="form-control fs-sm text-gray form-control-lg rounded-1" value="{{$content->sub_title}}" id="">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="mt-3">
                                        ...
                                        <select name="jenis" class="form-control fs-sm text-gray form-control-lg rounded-1" id="">
                                            ...
                                            <option @if($content->jenis == 1) selected @endif value="1">Materi</option>
                                            <option @if($content->jenis == 2) selected @endif value="2">Berita</option>
                                        </select>
                            ...
                            <div class="mt-3">
                                ...
                                <textarea name="body" class="bodyContent">{{$content->body}}</textarea>
