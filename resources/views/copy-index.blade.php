                        ...
                        <div class="col-9">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7">
                                            <img class="w-100" src="{{ Storage::url('content/hari-akhir.webp') }}"
                                                alt="">
                                        </div>
                                        <div class="col-5">
                                            <div class="d-flex flex-column h-100">
                                                <h4>Hari Akhir</h4>
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum adipisci
                                                    rem eius perferendis velit asperiores nesciunt quae? Cum tempore
                                                    dignissimos doloribus rerum perferendis unde, debitis, voluptate,
                                                    laborum facere corrupti ea!</p>
                            ...
                            <div class="card rounded-1 shadow-sm">
                                <div class="card-body mx-2 mt-1">
                                    <div class="header-card-audio d-flex">
                                        <img src="https://tailwindcss.com/_next/static/media/full-stack-radio.afb14e4e.png"
                                ...
                                <div class="card-footer border-0 position-relative shadow">
                                    <div class="my-2 ">
                                        <button
                                            class="btn btn-primary position-absolute rounded-circle bg-white text-dark border-0 shadow-sm">
                                        </button>
                                        {{-- <p class="mb-0">p</p> --}}
